...
statement
    : linearCatalogModifyingStatement   #linearCatalogModifyingStmt
    | linearDataModifyingStatement      #linearDataModifyingStmt
    | compositeQueryStatement           #compositeQueryStmt
    ;
